...
Ver tabla RA1–RA6 en la [propuesta](propuesta-cadi.md#5-resultados-de-aprendizaje). En resumen: fundamentos agénticos; brief y prompt de sistema; esqueleto de libro/ebook; presentación con narrativa y notas; revisión de artículo con agent log; evaluación con checklist.

---

## 4. Estructura por sesión
...
Materiales: [`sesiones/02-libros-y-ebooks/`](../sesiones/02-libros-y-ebooks/)
...
Materiales: [`sesiones/03-presentaciones/`](../sesiones/03-presentaciones/)

---

### Sesión 4 — Artículos y revisión; cierre (3 h)

**Objetivos:** Estructurar un micro-artículo o sección; aplicar agentes de revisión; cerrar microartefacto + agent log.
...
Taller + proyecto breve. Cada sesión combina:
...
| Evidencia | Descripción | Sesión |
|-----------|-------------|--------|
| E1 | Brief + prompt de sistema v0 | 1 |
| E2 | Outline y secciones de libro/ebook | 2 |
| E3 | Deck + notas de orador | 3 |
| E4 | Microartefacto + agent log + checklist | 4 |
...
## 8. Integridad académica y uso responsable de IA
